...
Checkout the [live preview here](https://peter-mowen.github.io/odin-admin-dashbaord/).

The goal of this project was to recreate the following design:

![Admin Dashboard Design Image from The Odin Project](doc/img/dashboard-project.png)
...
![Screenshot of my Admin Dashboard project submission](doc/img/my-admin-dashboard-submission.png)
